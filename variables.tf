...
variable "ecs_service_nginx_init_container_image" {
  type        = string
  default     = "mirror.gcr.io/alpine@sha256:8a1f59ffb675680d47db6337b49d22281a139e9d709335b492be023728e11715" # v3.22.0
  description = "Image to use for nginx init container"
}

variable "ecs_service_nginx_container_image" {
  type        = string
  default     = "mirror.gcr.io/nginxinc/nginx-unprivileged@sha256:5906f7b44fb9f54737bd57252fd2d7779b23dd5235243e7f9fd6c22e197853d4" # v1.29-perl
...
variable "ecs_service_tileserver_init_container_image" {
  type        = string
  default     = "mirror.gcr.io/amazon/aws-cli@sha256:48c3d4212e2f5b0e24bdc6af7708f9412ce65425a79575e0f78b8f8c0dcd70ab" # v2.27.50
